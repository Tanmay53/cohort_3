...
def listing():
    ...
    # print(total_pages, curr_page)
    prev_page_end = (curr_page-1)*per_page
    curr_page_end = curr_page * per_page
    # print(all_users[prev_page_end: curr_page_end])
    curr_page_users = all_users[prev_page_end: curr_page_end]

    data = {
        "curr_page_users": curr_page_users,
