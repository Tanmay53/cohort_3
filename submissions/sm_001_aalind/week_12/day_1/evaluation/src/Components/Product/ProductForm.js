        ...
        return (
            <div>
                ...
                <form className="form" onSubmit={this.handleForm}>
                    <label>Name</label>
                    <input type="text" name="itemName" required value={this.state.itemName} onChange={this.changeHandler} />
                    <label>Id</label>
                    <input type="text" name="itemId" required value={this.state.itemId} onChange={this.changeHandler} />
