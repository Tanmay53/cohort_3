  ...
  render() {
    return (
      <div>
        ...
        <div className="row my-2">
          <div className="mx-auto mt-5">
            ...
            <div className="input-group ">
              <input onKeyPress={this.handleEnter} id="inputTask" className="form-control" type="text" placeholder="Add Tasks here !" />
        ...
        <div className="row">
          {(this.state.toShow === false) ? <button onClick={this.handleShowCompleted} type="button" className="col-md-3 col-lg-2 col-sm-4 col-6 btn btn-outline-info mx-auto my-2">Show completed tasks</button> : <button onClick={this.handleShowCompleted} type="button" className="col-md-3 col-lg-2 col-sm-4 col-6 btn btn-outline-info mx-auto my-2">Hide completed tasks</button>}
        </div>
