...
1. Inherited
```
color,text-align,font-weight,font-size,visibility,
```
2. Non-Inherited
```
border,padding,clear,margin,background-color,display,height,width,z-index,overflow,position,float,word-wrap
```
