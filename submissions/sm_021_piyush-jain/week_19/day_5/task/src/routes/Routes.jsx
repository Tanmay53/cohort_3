        ...
        return (
            <React.Fragment>
                <nav class="navbar navbar-dark bg-dark">
                    <div><button class="btn btn-outline-primary"><Link to="/user" style={{ "color": "white", "textDecoration": "none" }}><h6>{this.state.name}</h6></Link></button></div>
                    <h6 style={{ "color": "white" }}><Link to="/home" style={{ "color": "white", "textDecoration": "none" }}><span class=" 	">TASK MANAGER</span></Link></h6>
                    <div>
                ...
                <Switch>
                    ...
                    <Route path="/crud/:id" exact render={(props) => <CrudTask {...props} />}></Route>
