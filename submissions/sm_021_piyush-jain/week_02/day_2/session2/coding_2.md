...
1. Inherited
```
color,font-size,display,text-align,font-weight,visibility,word wrap
```
2. Non-Inherited
```
border,padding,margin,background-color,height,width,overflow,z-index,float,position,clear
```
