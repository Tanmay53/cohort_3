...
class List extends React.Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <button onClick={this.handleCard}  class="btn btn-secondary m-2">Card format</button><button onClick={this.handleTable} style={{"float":"right"}} class="btn btn-secondary m-2">Table Format</button>
                {this.state.format == 1 ? <table class="table table-striped table-dark">
                    <thead>
                    ...
                    {this.state.db.map(item =>
                        ...
                        <div class="card-group">
                            ...
                            <div class="col-3">
                                <div class="card ">
                                    <img src="https://placeimg.com/640/480/people" class="card-img-top" alt="..." />
                                    <div class="card-body">
                                        <h5 class="card-title">{item.name}</h5>
                                        <p class="card-text">{item.email}</p>
                                        <p class="card-text">{item.number}</p>
                                        <div class="d-flex justify-content-between"><button class="btn btn-primary"><Link to={`/add_address/${item.id}`} style={{ "color": "white", "textDecoration": "none" }}>Add Address</Link></button>
