...
def count():
    count = 0
    with open("/home/piyush/coding/week_16/day_4/address/src/registration.csv", "r") as csvfile:
...
def registration():
    if request.method == "POST":
        reg = os.path.isfile(
            "/home/piyush/coding/week_16/day_4/address/src/registration.csv")
        with open("/home/piyush/coding/week_16/day_4/address/src/registration.csv", "a") as csvfile:
