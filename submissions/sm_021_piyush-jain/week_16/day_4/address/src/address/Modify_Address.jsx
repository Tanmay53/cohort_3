...
class Modify_Address extends React.Component {
    ...
    render() {
        ...
        <h4 style={{ "textAlign": "center" }}>Edit <span style={{ "color": "red" }}>{this.state.add_id} address of {this.state.id} </span>User Details</h4>
                    <div><label>LINE_1:</label><br></br><input type="text" style={{ "width": "100%" }} name="line_1" onChange={this.handleChange} placeholder={this.state.line_1}></input></div>
                    <div><label>LINE_2:</label><br></br><input type="text" style={{ "width": "100%" }} name="line_2" onChange={this.handleChange} placeholder={this.state.line_2}></input></div>
                    <div><label>PINCODE:</label><br></br><input type="text" style={{ "width": "100%" }} name="pincode" onChange={this.handleChange} placeholder={this.state.pincode}></input></div>
                    <div><label>CITY:</label><br></br><input type="text" style={{ "width": "100%" }} name="city" onChange={this.handleChange} placeholder={this.state.city}></input></div>
