    ...
    render(){
        return(
            <div className='container text-center'>
                <div className='col-9 offset-1 my-5 py-5'>
                    <div className='h2'>We pioneered the discount broking model in India.
                        Now, we are breaking ground with our technology.</div>
                </div>
                <div className='m-5 row text-left'>
                    <div className='col-6'>
                        <p>We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology.
                         ...
                         <p>   Today, our disruptive pricing models and in-house technology have made us the biggest stock broker in India in terms of active retail clients.
                            </p>
