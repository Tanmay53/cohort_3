...
1. Inherited
```
color, font-size,text-align,font-weight,word-wrap,
```
2. Non-Inherited,padding,margin,
```
border,background-color,display,visibility,clear
z-index,position,width,height,float,display
```
