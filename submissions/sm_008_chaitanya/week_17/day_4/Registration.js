...
var printOut = function (output) {
    var registerOut = document.createElement('h3')
        registerOut.textContent = output["message"]
        registerOut.setAttribute('class', 'text-center text-danger my-3')
        $(".container").append(registerOut)
}
