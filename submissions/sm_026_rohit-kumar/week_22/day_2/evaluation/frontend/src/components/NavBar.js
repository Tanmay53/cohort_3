...
function NavBar(props) {
    return (
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                <a class="navbar-brand" href="#"><b>Employee Records Manager</b></a>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item active">
                            <Link class="nav-link" to='/employee' > Add Employee <span class="sr-only">(current)</span></Link>
                        </li>  
                        <li class="nav-item active">
                            <Link class="nav-link" to='/department' > Add Department <span class="sr-only">(current)</span></Link>
                        </li>                    
                    </ul>
                    <ul class="navbar-nav">
