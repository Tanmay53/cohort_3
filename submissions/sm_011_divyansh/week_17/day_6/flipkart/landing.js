...
$(document).ready(function () {
    ...
    function createCard(array) {
        ...
        $("#cardsDiv").html("")
        array.forEach(obj => {
            let card = `<div class="card col-lg-2 col-md-4 col-sm-8 m-1 ml-5 border border-warning">
                    <img src="${obj.Image}" height="250px" class="card-img-top"">
                    <div class="card-body text-dark">
                        <h3 class="card-title ">Name : ${obj.Product}</h3>
                        <h4 class="card-subtitle mb-2 text-warning">Price : ${obj.Price}</h4>
