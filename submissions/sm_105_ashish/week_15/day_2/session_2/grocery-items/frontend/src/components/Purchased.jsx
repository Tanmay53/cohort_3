...
export default class Purchased extends Component {
    ...
    markPurchased = (e)=>{
        axios.post("http://127.0.0.1:5000/purchased/"+Number(e))
        .then(res=>{
        ...
        <div className ="col-6 m-auto text-center">
            <div class="card card-cascade narrower">
                ...
                <div class="card-body card-body-cascade">
                    ...
                    <p class="card-text">Are you sure you want to set this item as sold</p>
                    <button value={Number(this.props.match.params.id)} onClick={(e)=>this.markPurchased(e.target.value)} class="btn btn-danger">Mark Purchased</button>
                </div>
            </div>
        </div>
        )
