    ...
    return (
      ...
      <div className='container mt-5 mx-auto'>
        <div className='col-5 mx-auto'>
          ...
          <button className='mt-2 btn btn-outline-success' data-target='#confirmModal' data-toggle='modal'>Delete Item</button>
        </div>
      </div>
      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content">
          ...
          <div className="modal-footer">
            ...
            <button type="button" className="btn btn-outline-success" onClick={this.handleClick} data-dismiss="modal">Confirm Delete</button>
          </div>
        </div>
      </div>
    </div>
