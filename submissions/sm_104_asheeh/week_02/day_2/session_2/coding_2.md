...
1. Inherited
```
color, font-size, background-color, text-align, font-weight, visibility, word-wrap
```
2. Non-Inherited
```
overflow, padding, margin, border, display, float, height, width, z-index, position, clear
```
